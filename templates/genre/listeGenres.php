    ...
    foreach($lesGenres as $genre){
        ...
        echo "<td class='col-md-2'>
            ...
            <a href='#modal-delete' data-toggle='modal' data-message='Voulez vous supprimer ce genre ?' data-delete='index.php?uc=genres&action=delete&num=".$genre->getNum()."' class='btn btn-danger'><i class='far fa-trash-alt'></i></a>
        </td>";
        echo "</tr>";
    }
